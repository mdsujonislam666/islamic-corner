    ...
    return (
        <section className="lg:mx-32 py-5 flex flex-col items-center">
            <div className="space-y-4 mb-14">
                <h2 className="text-5xl font-bold text-center py-10">Update<span className="text-red-500">Product</span>
                </h2>
                <h3 className="text-2xl text-center">For your safe purchase and best choice's</h3>
            </div>
            ...
            <div className="carousel w-full bg-orange-200  lg:h-[600px]">
                <div id="slide1" className="carousel-item relative w-full  ">
                    <div className="flex flex-col lg:flex-row gap-20 p-4 lg:p-24">
                        <div className="flex-1 space-y-7 py-20">
                            <h3 className="text-3xl text-black font-bold">Al-Quran</h3>
                            <p className='text-black'>The Prophet ﷺ said:
                ...
                <div id="slide2" className="carousel-item relative w-full">
                    <div className="flex flex-col lg:flex-row p-4 lg:p-24 gap-20">
                        <div className="space-y-7 flex-1 py-20">
                            <h3 className="text-3xl text-black font-bold">Islamic Tasbih</h3>
                            <p className='text-black'>The Prophet ﷺ said:
                ...
                <div id="slide3" className="carousel-item relative w-full">
                    <div className="flex flex-col lg:flex-row gap-20 p-4 lg:p-24">
                        <div className="flex-1 space-y-7 py-20">
                            <h3 className="text-3xl text-black font-bold">Islamic Jainamaj</h3>
                            <p className='text-black'>Sahih Bukhari (381)
